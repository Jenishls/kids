    ...
    <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
        <div class="kt-header-mobile__logo">
            <a href="demo8/index.html">
                <img style="width: 55px; height: 55px; border-radius: 58px;" alt="Logo" src="{{default_sidebar_icon()?:"images/no-image.png"}}">
            </a>
                {{-- <img alt="Logo" src="media/logos/logo-8-sm.png" /> --}}
            </a>
        </div>
                        ...
                        <div id="kt_aside_menu" class="kt-aside-menu  kt-aside-menu--dropdown " data-ktmenu-vertical="1" data-ktmenu-dropdown="1" data-ktmenu-scroll="0">		
                            ...
                            <ul class="kt-menu__nav ">
                                ...
                                @if(!$menu->subMenus->count())
                                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--submenu-fullheight" aria-haspopup="true"  data-toggle="kt-tooltip" data-placement="left" title="" data-original-title="{{ucwords($menu->name)}}">
                                        <a  class="kt-menu__link kt-menu__toggle @if(strtolower($menu->name)!=='admin') pageload @endif"  @if(strtolower($menu->name)!=='admin') data-route="{{$menu->route}}"
                                            @else href="/admin"@endif>
                                                <i class="kt-menu__link-icon {{$menu->icon_class}}" ></i>
                                           
                                            <span class="kt-menu__link-text text-capitalize" >{{$menu->name}}</span>
                                            <i class="kt-menu__ver-arrow la la-angle-right"></i>
                                        </a>
                                    </li>
                                @else
                                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--submenu-fullheight" aria-haspopup="true" data-ktmenu-submenu-toggle="click" data-ktmenu-dropdown-toggle-class="kt-aside-menu-overlay--on"  title="{{ucwords($menu->name)}}">
                                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle pageload"  data-route="{{$menu->route}}">
                                        @foreach($icons as $icon)
                                        @if(strtolower($icon->icon_name) === strtolower($menu->name))
