...
<div class="modal-dialog custom_dialog" role="document" style="min-width: 800px !important; max-width: 800px !important;">
    <div class="modal-content" style="width: 650px !important;">
                                                        ...
                                                        <table class="mail-form-table mr-10 ml-10">
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                        <textarea id="mailfrom" rows="1" readonly class="form-control">{{$setting?$setting->email_from:""}}</textarea>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td style="width: 30px;">
                                                                        ...
                                                                        <td>
                                                                        <textarea name="to" id="mailTo" rows="1" class="form-control">{{$to}}</textarea>
                                                                        </td>
                                                                        <td style="width: 20px">
                                                                    ...
                                                                    <div class="dropzone-items col-md-4">
                                                                        <div class="dropzone-item dz-processing dz-image-preview dz-success dz-complete" style="max-width: 100%; overflow: hidden;">
                                                                            <div class="dropzone-file">
                                                                                <div class="dropzone-filename text-left" title="{{$pdf}}">
                                                                                    <i class="flaticon-attachment"></i>
                                                                                    <span data-dz-name="">{{str_limit($quote->quote_number." PDF", 20)}}</span> 
        ...
        <div class="modal-footer" style="display: inline-block; background: #eee;">
            ...
            <button type="" class="btn btn-sm btn-pill btn-success float-right" id="sendQuoteMail">Send Mail <i class="la la-save"></i></button>
        </div>
...
<script>    
    ...
    $('#sendQuoteMail').off('click').on('click', function(e){
        e.preventDefault();
        let data = new FormData(document.getElementById('send_mail_form'));
        $.ajax({
            url:'/admin/mail/sendMail/{{$quote->id}}',
            method: 'POST',
            ...
            success: function(response){
                ...
                $('#QuoteMailLogdataTable').KTDatatable().reload(); 
            }, 
