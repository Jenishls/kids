<div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Company Icons - Edit</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary sy_icon" data-id="" id="updateIcon">Update</button>
            </div>
        </div>
    </div>
    
    <script>
        $(document).off('click', '#updateIcon').on('click', '#updateIcon', function(e) {
            console.log('sada');
            e.preventDefault();
            e.stopPropagation();
            ...
            method: 'POST',
            data: new FormData(document.getElementById('editIconForm')),
            contentType: false,
            processData: false,
            success: function(response){
                $('#cModal').modal('hide');
                icons();
                toastr.success('Icon Successfully updated.');
            }, 
