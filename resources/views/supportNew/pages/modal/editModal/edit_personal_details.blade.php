    ...
    <div class="modal-content addUserModal">
        ...
        <form id ="edit_personal_detail_form">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary sy_icon info_update" data-route="/admin/update/personalDetail" data-id="{{$user->id}}" id="personal_info_save_btn" >Update</button>
            </div>
        </form>
    </div>
</div>
