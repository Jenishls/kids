...
<div class="modal-dialog custom_dialog" role="document" >
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="margin-left:2.5rem;" id="cWizardTitle"> <i class="la la-plus"></i>  Members</h5>
        ...
        <div class="modal-body" style="padding:0px !important;" >
            ...
            --tabs" style="margin-bottom:0px !important;">
                <div class="kt-portlet__body" style="background:#e5f7ff !important; padding:0px !important;"> 
                    <form class="kt-form kt-form--label-right" id="account_add_form" data-cid={{$company->id}}>   
                        @csrf
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    <div class="col-md-6 kt-align-right ml-auto" >
                                        <button type="" class="btn btn-sm btn-pill btn-success" data-cid="{{$company->id}}" id="storeMembers">Save <i class="la la-save"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
$('#storeMembers').off('click').on('click', function(e){
  e.preventDefault();
  let data = $('#account_add_form').serializeArray();
  supportAjax({
    url:'/admin/account/update/member/'+$(this).attr('data-cid'),
    method:'Post',
    data
  }, function(resp){
    $('#cModal1').modal('hide');
