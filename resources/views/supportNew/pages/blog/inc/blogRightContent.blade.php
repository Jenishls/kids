                    ...
                    <div class="kt-inbox__head" style="display: flex;">
                        ...
                        <div class="kt-inbox__actions">
                            ...
                            <div class="kt-inbox__group">
                                <span class="kt-inbox__icon kt-inbox__icon--label kt-inbox__icon--light view_span viewBlog" data-toggle="kt-tooltip" data-placement="top" title="" data-original-title="View" data-route="/admin/view/blog/{{$blog->id}}">
                                    <i title="View profile" class="la la-eye"></i>
                                </span>
                                    
                                <span class="kt-inbox__icon kt-inbox__icon--label kt-inbox__icon--light edit_span edit_blog editBlog"  data-id="" data-route="/admin/edit/blog/{{$blog->id}}" data-placement="top" title="Edit Blog" >
                                    <i class="la la-edit"></i>
                                </span>
