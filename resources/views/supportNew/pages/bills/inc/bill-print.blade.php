                        ...
                        <div class="row" style="padding: 10px;">
                            <div class="billMemberName col-6">
                                <h4 class="kt-invoice__title">
                                    {{isset($bill->account_id)?ucfirst($bill->account->company_name): ucfirst($bill->member->name)}}
                                </h4>
                            </div>
                                ...
                                <div class="btn-group">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton" style="">
                                            <a class="dropdown-item statusUpdate kt-font-success" data-id="{{$bill->id}}" data-status="approved" @if($bill->status === 'approved') hidden @endif><i class="flaticon2-check-mark kt-font-success"></i>Mark as approved</a>
                                            <a class="dropdown-item statusUpdate kt-font-danger" data-id="{{$bill->id}}" data-status="not approved" @if($bill->status === 'approved') hidden @endif><i class="flaticon2-cross kt-font-danger"></i> Disapprove</a>
                                            <a class="dropdown-item kt-font-info"><i class="flaticon-upload kt-font-info"></i> Upload Bills</a>
