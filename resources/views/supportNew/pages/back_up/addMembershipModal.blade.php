<div class="modal-dialog" role="document" style="margin-left: 21%;" id="membership_modal_body">
        <div class="modal-content modal-1200">
            ...
            <form id ="add_membership_form">
                                ...
                                <div class="row">
                                    <div class="form-group label-floating col-md-2">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 id_card_look_up addModal" data-route="addModal/id_card_look_up/{{$user->id}}" data-id="{{$user->id}}">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary sy_icon" data-route="/addMembership" data-id="{{$user->id}}" id="add_new_membership" >Save</button>
                </div>
            </form>
        </div>
    </div>
    <script>
        ...
        $(document).off('click','#btnAddRow').on('click','#btnAddRow', function() {
            const  newRow = 
            `<div class="row"  data-id="${membership_add_row}">
                <div class="col-11">
                    @csrf
                    <div class="row">
                        ...
                        <div class="form-group label-floating col-md-2">
                            ...
                            <input class="form-control" value="" type="text" id="" name="place_issued[]">
                        </div>
    ...
    @include('support.pages.modal.addModal.id_card_look_up')