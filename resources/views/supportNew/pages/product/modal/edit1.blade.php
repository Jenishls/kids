...
<div class="modal-dialog custom_dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="margin-left:2.5rem;" id="cWizardTitle"><i class="la la-plus"></i> Product</h5>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group col-lg-12 col-md-12 col-sm-6 mediaShadowInput" >
                                                            <div class="shadow_inputs">
                                                                ...
                                                                <span class="btn btn-sm portlet_label btn-icon"  id="adddCategory" style="top: -13px!important;right: 38px;left:unset;">
