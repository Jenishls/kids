<style>
    ...
    <div class="modal-dialog addProductModalDialog modal-md" role="document" style="margin-top: 4% !important; margin-left: 28% !important;">
        <div class="modal-content addProductModal" style="width: 1000px;">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Reply FAQ</h5>
            ...
            <div class="modal-body" style="padding:0px !important;">
                <div class="kt-portlet" style="margin-bottom:0px !important;">
                    <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                        <form class="kt-form kt-form--label-right" id="productRepyForm">   
                            @csrf
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="" class="btn btn-success btn-pill" id="replyfaq">Reply</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).off('click','#replyfaq').on('click','#replyfaq',function(e){
            e.preventDefault();
            $.ajax({
                url:'/admin/products/tab/faq/reply/{{$faq->id}}',
                method: 'POST',
                data: new FormData(document.getElementById('productRepyForm')),
                contentType: false,
                processData: false,
                success: function(response){
                    ...
                    $.ajax({
                        method: "get",
                        url: "admin/products/tab/faq/{{$faq->table_id}}",
                        beforeSend: function () {
