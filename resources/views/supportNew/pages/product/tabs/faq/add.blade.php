<style>
            ...
            <div class="modal-body" style="padding:0px !important;">
                <div class="kt-portlet" style="margin-bottom:0px !important;">
                    <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                        <form class="kt-form kt-form--label-right" id="productFaqForm">   
                            @csrf
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="" class="btn btn-success btn-pill" id="storefaq">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).off('click','#storefaq').on('click','#storefaq',function(e){
            e.preventDefault();
            $.ajax({
                url:'/admin/products/tab/faq/add/{{$product}}',
                method: 'POST',
                data: new FormData(document.getElementById('productFaqForm')),
                contentType: false,
                processData: false,
                success: function(response){
                    ...
                    $.ajax({
                        method: "get",
                        url: "admin/products/tab/faq/{{$product}}",
                        beforeSend: function () {
