<style>
                                            ...
                                            <div class="form-group col-12 box_shadow" >
                                                <div class="product_color">
                                                    <div class="form-group row" style="padding: 5px;">
                                                        <button type="button" id="add_more" class="btn btn-info btn-sm btn-icon" style="height: 1.5rem; width: 1.5rem; background: #49bdf4; border: #47bdf5; position: absolute; right: 10px; top: 50px; z-index: 9;"><i class="fa fa-plus"></i></button>
                                                        ...
                                                        <div class="col-md-2" style="flex: 0 0 20%; max-width: 18%;">
        ...
        <script>
            ...
            $(document).off('click','#storeSize').on('click','#storeSize',function(e){
                e.preventDefault();
                $.ajax({
                    url:'/admin/products/tab/size/add/{{$product}}',
                    method: 'POST',
            ...
            function createTemplate() {
                return (
                    `<div class="form-group row clowngroup" style="padding: 5px; position: relative;">
