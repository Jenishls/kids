<style>
        ...
        <div class="modal-dialog addProductModalDialog modal-md" role="document" style="margin-top: 4% !important; margin-left: 17% !important;">
            <div class="modal-content addProductModal" style="width: 1300px;">
                ...
                <div class="modal-body" style="padding:0px !important;">
                    <div class="kt-portlet" style="margin-bottom:0px !important;">
                        <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                            <form class="kt-form kt-form--label-right" id="productSizeForm">   
                                @csrf
                                        ...
                                        <div class="kt-form__actions">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 kt-align-right">
                                                    <button type="" class="btn btn-success btn-pill" id="storeSize">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            initilizeSelect2();
            $(document).off('click','#storeSize').on('click','#storeSize',function(e){
                e.preventDefault();
                $.ajax({
                    url:'/admin/products/tab/inventory/add/{{$product}}',
                    method: 'POST',
                    data: new FormData(document.getElementById('productSizeForm')),
                    contentType: false,
                    processData: false,
            ...
            function createTemplate() {
                return (
                    `<div class="form-group row" style="padding: 5px; position: relative;">
                        <button type="button" class="btn btn-info btn-sm btn-icon removeCloned" style="height: 1.5rem; width: 1.5rem; background: #be0505; border: #be0505; position: absolute; right: 10px; top: 40px; z-index: 9;">
