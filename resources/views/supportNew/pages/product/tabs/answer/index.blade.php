<div class="kt-subheader   kt-grid__item" id="kt_subheader" style="width: 100%;">
    <div class="kt-container  kt-container--fluid ">
        ...
        <button type="button" class="btn btn-info btn-elevate btn-pill btn-sm ml-auto" id="add_faq" data-route="/admin/products/tab/answer/add/{{$product->id}}"><i class="flaticon-add"></i> Add</button>
        </div>
    </div>
</div>

<div id="productFaqTable" style="width: 100%">
    @include('.supportNew.pages.product.tabs.answer.answer')
</div>
<script>
