<style>
            ...
            <div class="modal-body" style="padding:0px !important;">
                <div class="kt-portlet" style="margin-bottom:0px !important;">
                    <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                        <form class="kt-form kt-form--label-right" id="productQuestionForm">   
                            @csrf
                                        ...
                                        <div class="form-group col-12 box_shadow" >
                                            <div class="product_color">
                                                <div class="form-group row" style="padding: 5px; position: relative;">
                                                    <div class="col-lg-12">
                                                        <label class="control-label boldLabel">Question</label>
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="" class="btn btn-success btn-pill" id="storeQuestion">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).off('click','#storeQuestion').on('click','#storeQuestion',function(e){
            e.preventDefault();
            $.ajax({
                url:'/admin/products/tab/answer/add/{{$product}}',
                method: 'POST',
                data: new FormData(document.getElementById('productQuestionForm')),
                contentType: false,
                processData: false,
                success: function(response){
                    ...
                    $.ajax({
                        method: "get",
                        url: "admin/products/tab/answer/{{$product}}",
                        beforeSend: function () {
