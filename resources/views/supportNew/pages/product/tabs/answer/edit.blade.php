<style>
            ...
            <div class="modal-body" style="padding:0px !important;">
                <div class="kt-portlet" style="margin-bottom:0px !important;">
                    <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                        <form class="kt-form kt-form--label-right" id="productFeatureEditForm">   
                            @csrf
                                            ...
                                            <div class="product_color">
                                                <div class="form-group row" style="padding: 5px;">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <textarea class="form-control" rows="2" name="feature">{{$feature->feature}}</textarea>
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="" class="btn btn-success btn-pill" id="updatefeature">Save</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $(document).off('click','#updatefeature').on('click','#updatefeature',function(e){
            e.preventDefault();
            $.ajax({
                url:'/admin/products/tab/feature/update/{{$feature->id}}',
                method: 'POST',
                data: new FormData(document.getElementById('productFeatureEditForm')),
                contentType: false,
                processData: false,
