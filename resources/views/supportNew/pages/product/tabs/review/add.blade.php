<style>
            ...
            <div class="modal-body" style="padding:0px !important;">
                <div class="kt-portlet" style="margin-bottom:0px !important;">
                    <div class="kt-portlet__body" style="background:#e4e4e4 !important; padding:0px !important;"> 
                        <form class="kt-form kt-form--label-right" id="productReviewForm">   
                            @csrf
                                            ...
                                            <div class="product_color">
                                                <div class="form-group row" style="padding: 5px; position: relative;">
                                                    <div class="col-lg-8">
                                                        ...
                                                        <input class="form-control" type="text" name="title" required="require" autocomplete="off">
                                                        <div class="errorMessage"></div>
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label class="control-label boldLabel" for="salutation">Stars</label>
                                                        <input class="form-control" type="text" name="stars" required="require" autocomplete="off">
                                                        <div class="errorMessage"></div>
                                                    </div>
                                                    <div class="col-lg-12">
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="" class="btn btn-success btn-pill" id="storeReview">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(document).off('click','#storeReview').on('click','#storeReview',function(e){
            e.preventDefault();
            $.ajax({
                url:'/admin/products/tab/review/add/{{$product}}',
                method: 'POST',
                data: new FormData(document.getElementById('productReviewForm')),
                contentType: false,
                processData: false,
