...
<div class="modal-dialog custom_dialog" role="document" style="min-width: 800px !important; max-width: 800px !important;">
    <div class="modal-content" style="width: 650px !important;">
        <div class="modal-header">
            <h5 class="modal-title" style="margin-left:2.5rem;" id="cWizardTitle">View Mail</h5>
                                                ...
                                                <div class="form-group row ">
                                                        <table class="mail-form-table mr-10 ml-10">
                                                                <tbody>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="to" id="mailTo" readonly  rows="1" class="form-control">
                                                                            {{$mail->to}}
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <textarea name="cc" readonly  rows="1" class="form-control">
                                                                            {{$mail->cc}}
                                                                        </textarea>
                                                                    </td>
                                                                    <td style="width: 20px">
                                                        ...
                                                        <table class="mail-form-table mr-10 ml-10">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                    <input type="text" readonly  name="subject" class="form-control" value="{{$mail->subject}}">
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    <div class="col-md-12 col-sm-12 mt-10">
                                                        <textarea class="form-control" name="message" readonly  id="message" cols="30" rows="10">{!!$mail->message!!}</textarea>
                                                        ...
                                                        <div class="kt-inbox__attachments">
                                                            <div class="dropzone dropzone-multi row" id="kt_inbox_compose_attachments" style="min-height: unset;">
                                                                    ...
                                                                    <div class="dropzone-items col-md-4">
                                                                        <div class="dropzone-item dz-processing dz-image-preview dz-success dz-complete" style="max-width: 100%; overflow: hidden;">
                                                                            <div class="dropzone-file">
                                                                                <div class="dropzone-filename text-left" title="{{$file->file_name}}">
                                                                                    <i class="flaticon-attachment"></i>
                                                                                    <span data-dz-name="">{{str_limit($file->file_name, 20)}}</span> 
                                                                                </div>
        ...
        {{-- <div class="modal-footer" style="display: inline-block; background: #eee;">
            ...
            <button type="" class="btn btn-sm btn-pill btn-success float-right" id="storeOrder">Send Mail <i class="la la-save"></i></button>
        </div> --}}
...
<script>    
    ...
    //     e.preventDefault();
    //     let data = $('#send_mail_form').serializeArray();
    //     supportAjax({
