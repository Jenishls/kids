...
<div class="custom-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Fund To {{$c_master->name}}</h5>
                                ...
                                <div class="kt-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 kt-align-right">
                                            <button id="addFundToAccount" class="btn btn-pill btn-success" data-id="{{$c_master->id}}"><i class="la la-money"></i>Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
