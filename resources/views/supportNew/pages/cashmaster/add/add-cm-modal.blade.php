...
<div class="custom-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Add Cash Master</h5>
        ...
        <div class="modal-body" style="padding:0px !important;">
            <div class="kt-portlet" style="margin-bottom:0px !important;">
                ...
                <div class="kt-portlet__body" style="background:#e5f7ff !important; padding:0px !important; padding-top:0px!important;color:#000;"> 
                    <form class="kt-form kt-form--label-right" id="addCashMasterForm" style="margin-top:15px;">   
                        @csrf
                                            ...
                                            <div class="form-group row" style="padding:5px;">
                                                <div class="form-group  col-md-11">
                                                    ...
                                                    <select class="form-control" name="location" id="locationSelect">
                                                        <option value="">Select</option>
                                                        <option value="kathmandu">Just For Test</option>
                                                    </select>
                                                    <div class="errorMessage"></div>
                                                </div>
                                ...
                                <div class="kt-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 kt-align-right">
                                            <button id="createCashMaster" class="btn btn-pill btn-success"><i class="la la-save"></i>Save</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).off('click', '#createCashMaster').on('click', '#createCashMaster', function(e){
        e.preventDefault();
        let cashMasterForm = $('#addCashMasterForm');
        let data = $('#addCashMasterForm').serializeArray();
        supportAjax({
