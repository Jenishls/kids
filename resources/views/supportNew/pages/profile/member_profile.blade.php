...
<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid" style="margin-top:20px;">
    <!--begin:: Portlet-->
                            ...
                            <div class="kt-section__content kt-section__content--solid">
                                <div class="kt-media-group">
                                    <a href="#" class="kt-media kt-media--sm kt-media--circle" data-toggle="kt-tooltip" data-skin="brand" data-placement="top" title="" data-original-title="John Myer">
                                        <img src="{{asset('asset/media/users/100_7.jpg')}}" alt="image">
                                    </a>
                ...
                <div class="kt-portlet__body kt-portlet__body--fluid">
                    <div class="kt-widget12">
                        ...
                        <div class="kt-widget12__chart" style="height:250px;">
                            ...
                            <canvas id="kt_chart_order_statistics" style="display: block; width: 734px; height: 250px;" width="734" height="250" class="chartjs-render-monitor"></canvas>
                        </div>
                    </div>
                </div>
            </div>
