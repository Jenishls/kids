...
<div class="custom-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Edit Bank Master</h5>
            ...
            <div class="kt-portlet" style="margin-bottom:0px !important;">
               {{-- {{dd($b_master)}} --}}
                <div class="kt-portlet__body" style="background:#e5f7ff !important; padding:0px !important; padding-top:0px!important;color:#000;"> 
                    <form class="kt-form kt-form--label-right" id="editBankMasterForm" style="margin-top:15px;">   
                        @csrf
                                        ...
                                        <div class="">
                                            <div class="form-group row" style="padding:5px;">
                                                <div class="form-group  col-md-6" style="padding-top:10px;">
                                                    ...
                                                    <input class="form-control" type="text" value="{{$b_master->name}}" name="name">
                                                ...
                                                <div class="form-group  col-md-5" id="type_member" style="padding-top:10px;">
                                                    ...
                                                    <select class="form-control" name="account_id" id="companySelect">
                                                        <option value="{{$b_master->account_id}}" selected>{{$b_master->account->company_name}}</option>
                                                    </select>
                                                    <div class="errorMessage"></div>
                                                </div>
                                            ...
                                            <div class="form-group row" style="padding:5px;">
                                                <div class="form-group  col-md-6">
                                                    ...
                                                    <input class="form-control" type="text" value="{{$b_master->account_name}}"  name="account_name">
                                                    <div class="errorMessage"></div>
                                                </div>
                                                <div class="form-group  col-md-6">
                                                    <label class="control-label" for="account_number">Account No.</label>
                                                    <input class="form-control" type="text" value="{{$b_master->account_number}}"  name="account_number">
                                                    <div class="errorMessage"></div>
                                                </div>
                                            </div>
                                            <div class="form-group row" style="padding:5px;">
                                                <div class="form-group  col-md-6">
                                                    ...
                                                    <select class="form-control" name="account_type" id="accType">
                                                        ...
                                                        <option value="saving" @if($b_master->account_type === 'saving')selected @endif>Saving Account</option>
                                                        <option value="current" @if($b_master->account_type === 'current')selected @endif>Current Account</option>
                                                        <option value="fixed" @if($b_master->account_type === 'fixed')selected @endif>Fixed Account</option>
                                                    </select>
                                                    <div class="errorMessage"></div>
                                                </div>
                                                    <div class="form-group  col-md-6">
                                                    <label class="control-label" for="openedDate">Opened Date</label>
                                                    <input class="form-control" type="text" id="openedDate"  name="opened_date" value="{{\Carbon\Carbon::parse($b_master->opened_date)->format('m/d/Y')}}">
                                                    <div class="errorMessage"></div>
                                                </div>
                                            </div>
                                            <div class="form-group row" style="padding:5px;">
                                                <div class="form-group  col-md-6">
                                                    ...
                                                    <input class="form-control" type="text" value="{{$b_master->branch}}" name="branch">
                                                    <div class="errorMessage"></div>
                                                </div>
                                ...
                                <div class="kt-form__actions">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 kt-align-right">
                                            <button id="updateBankMaster" class="btn btn-pill btn-success" data-id="{{$b_master->id}}"><i class="la la-upload"></i>Update</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $(document).off('click', '#updateBankMaster').on('click', '#updateBankMaster', function(e){
        e.preventDefault();
        let bankMasterForm = $('#editBankMasterForm');
        let data = $('#editBankMasterForm').serializeArray();
        let id = $(this).attr('data-id');
        supportAjax({
            url: `/admin/bankmaster/edit/${id}`,
            method: "POST",
            data: data
        }, function(resp){
            $('#cModal').modal('hide');
