...
<div class="modal-dialog custom_dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="margin-left:2.5rem;" id="cWizardTitle">Add Tasks</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:cornsilk;">
            </button>
        </div>
        <div class="modal-body" style="padding:0px !important;" id="taskAddWizard">
            <div class="kt-portlet kt---tabs" style="margin-bottom:0px !important;">
                <div class="kt-portlet__head" style="padding:0px !important;">
                    <div class="kt-portlet__head-toolbar" style="width:100%;padding: 0 25px;">
                        <ul class="nav  nav-tabs-line" role="tablist"  style="width: 100%;display:flex;">
                            ...
                            <li class="wizard-tabs col-sm-12" data-target="#assignMemberSection" style="flex:1;margin-right:0px !important;">
                                <a class="nav-link modal_tab_headers"  data-toggle="tab"  href="javascript:" role="tab" aria-selected="false">
                                    <i class="flaticon-map mr-1"></i> Assign Members
                                </a>
                            </li>
                            <li class="wizard-tabs col-sm-12"  data-target="#attachmentSection" style="flex:1;margin-right:0px !important;">
                ...
                <div class="kt-portlet__body" style="background:#e5f7ff !important; padding:0px !important;"> 
                    <form class="kt-form kt-form--label-right" id="taskCreateForm">   
                        @csrf
                        <div class="tab-content">
                            <div class="wizard-panel active" id="taskFormSection" role="tabpanel" style="background:#e5f7ff !important;">
                                <div class="kt-portlet__body" style="padding:25px;padding-bottom:0px !important;">
                                    @include('supportNew.pages.tasks.modal.include_add.task_info')
                                </div>
                            </div>
                            <div class="wizard-panel" id="assignMemberSection" style="background:#e5f7ff !important;">
                                <div class="kt-portlet__body" style="padding: 20px 25px 0!important;">
                                    @include('supportNew.pages.tasks.modal.include_add.task_members')
                                </div>
                            </div>
                            <div class="wizard-panel" id="attachmentSection" style="background:#e5f7ff !important;">
                                    @include('supportNew.pages.tasks.modal.include_add.task_attachments')
                            </div>
                        </div>
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 wizard--btn kt-align-right ml-auto" data-wizard-step="save">
                                        <button type="" class="btn btn-sm btn-pill btn-success" id="btnCreateTask">Save <i class="la la-save"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    var taskAddWizard = $('#taskAddWizard').WizardForm();
    taskAddWizard.on('nextBtn', function(wizard){
        wizard.sendAjax(wizard.currentStep().data("validateurl"));
    });

    taskAddWizard.on("formChange",function(wizard){
    ...
    e.preventDefault();
        ...
        let data = $("form#taskCreateForm").serializeArray()
        supportAjax({
