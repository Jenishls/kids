...
<div class="modal-dialog " role="document" style="width: 700px !important; max-width: 700px !important;">
    <div class="modal-content ">
                        ...
                        <div class="form-group col-md-12 p-25" style="padding-bottom: 15px !important;">
                                <div class="shadow_inputs">
                                    <div class="form-group row">
                                        ...
                                        <input class="form-control" type="text" value="{{str_replace(',', '', $balance)}}" readonly name="amount">
                                        </div>
                                        <div class="form-group  col-md-6">
        ...
        <div class="modal-footer" style="display: inline-block; background: #eee;">
                <button type="reset" class="btn btn-secondary btn-pill" data-dismiss="modal" id="cancel_payment"> <i class="la la-times"></i> Cancel</button>
...
<script>
    $(document).ready(function(e){
        ...
        $(document).off('click','#makeInvoicePayment').on('click','#makeInvoicePayment',function(e){
            e.preventDefault();
            payment_data = new FormData(document.getElementById('paymentForm'));
            check_payment = 1;
            $('#updateMoving').click();
            $('#updatePickup').click();
            $('#addOrderPackage').click();
            $('#cModal3').modal('hide');
            $('#cModal1').modal('hide');
        });
        ...
        $(document).off('click','#cancel_payment').on('click','#cancel_payment',function(e){
            e.preventDefault();
            check_payment = 1;
        });
    });
