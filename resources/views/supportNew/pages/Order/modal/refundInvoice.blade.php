                                        ...
                                        <div class="row mb-10">
                                            <div class="form-group col-12">
                                                <div class="alert alert-light alert-elevate width-100 mb-0" role="alert">
                                                    ...
                                                    <div class="alert-text">Shorten of Pickup Date will make a Refund on following items.
                                                        <div class="alert-text" style="font-weight: bold;">Shorten: <span class="mr-30" style="color: #fd397a">{{$days}} Days</span> Total Refund Amount: <span style="color: #fd397a">$ {{ number_format((float)$amount, 2, '.', '')}}</span></div>
                                                    </div>
                                    ...
                                    <div class="kt-form__actions">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 kt-align-right">
                                                <button type="reset" class="btn btn-success" id="extendOrder"> <i class="la la-plus"></i> Refund </button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
