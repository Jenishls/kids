...
<div class="modal-dialog custom_dialog" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" style="margin-left:2.5rem;" id="cWizardTitle">Update Project</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="color:cornsilk;">
            </button>
        </div>
        <div class="modal-body" style="padding:0px !important;" id="projectUpdateWizard">
                ...
                <div class="kt-portlet__body" style="background:#e5f7ff !important; padding:0px !important;"> 
                    <form class="kt-form kt-form--label-right" id="projectAddForm">   
                        ...
                        <div class="tab-content">
                            <div class="wizard-panel active" id="projectInfoSection" data-url="/admin/project/update/info" role="tabpanel" style="background:#e5f7ff !important;">
                                <div class="kt-portlet__body" style="padding:25px;padding-bottom:0px !important;">
                                    <input type="hidden" name="id" value="{{$project->id}}">
                                    @include('supportNew.pages.project.modal.include_edit.project_info')
                                </div>
                            </div>
                            <div class="wizard-panel" id="projectMemberSection" data-url="/admin/project/update/members" style="background:#e5f7ff !important;">
                                <div class="kt-portlet__body" style="padding: 20px 25px 0!important;">
                                    <input type="hidden" name="id" value="{{$project->id}}">
                                    @include('supportNew.pages.project.modal.include_edit.project_members')
                                </div>
                            </div>
                            <div class="wizard-panel" id="projectAttachmentSection" data-url="/admin/project/update/attachments" style="background:#e5f7ff !important;">
                                    <input type="hidden" name="id" value="{{$project->id}}">
                                    @include('supportNew.pages.project.modal.include_edit.project_attachments')
                            </div>
                        </div>
                            ...
                            <div class="kt-form__actions">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 kt-align-right wizard--btn ml-auto" data-wizard-step="next">
                                        <button type="" class="btn btn-sm btn-pill btn-success">Save & Continue <i class="la la-arrow-right"></i></button>
                                    </div>
                                    <div class="col-md-6 wizard--btn kt-align-right ml-auto" data-wizard-step="save">
                                        <button type="button" class="btn btn-sm btn-pill btn-success" id="btnProjectUpdate" data-id="{{$project->id}}">Update <i class="la la-save"></i></button>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    var wizardProjectAdd = $('#projectAddWizard').WizardForm();
        ...
        var taskUpdate = $('#projectUpdateWizard').WizardForm();
    ...
    // $('#btnProjectUpdate').off('click').on('click', function(e){
    // e.preventDefault();
