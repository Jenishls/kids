<div class="row" id="branchFormContainer">
    <div class="col-md-12 col-sm-12">
     <div class="kt-portlet kt-portlet--mobile">
       <div class="kt-portlet__body pt-0 px-3">
          ...
          <div class="row">
              <div class="col-md-12">
                  <div id="projectMemberDatatable" data-id="{{$project->id}}"></div>
              </div>
          </div>
       </div>
     </div>
 ...
 var projectId = $('#projectMemberDatatable').attr("data-id");
 console.log(projectId);
 var taskDatatable = $('#projectMemberDatatable').KTDatatable({
        // datasource definition
        data: {
            type: 'remote',
            source: {
                read: {
                    url: '/admin/users/list?project_id='+projectId,
                    method: 'get',
                    map: function(raw) {
                        // sample data mapping
                        var dataSet = raw;
