...
<div id="datatable_container" class="usersControlContent">
	<div class="kt-subheader kt-grid__item uc_subHeader userControlSubHeader" id="kt_subheader">
        ...
        <div class="kt-subheader__wrapper">
            <button class="btn btn-pill btn-brand btn-elevate btn-icon-sm" id="add_sitesetting"><i class="la la-plus"></i>
                Add
            </button>
        </div>
	</div>
...
<script type="text/javascript">
    ...
    // datasource definition
			...
			},
        {
            ...
            template: function(row, index, datatable) {
                ...
                return     '<a id="edit_sitesetting" class="btn btn-hover-brand btn-icon btn-pill model_load" data-route="/admin/siteSetting/editmodal/'+row.id+'" href="JavaScript:void(0);" data-toggle="modal" data-target="#sy_global_modal"  title="Edit details">\
    ...
    $(document).off('click', '#edit_sitesetting').on('click', '#edit_sitesetting', function(e){
        ...
        let id= $(this).data('id');
        delConfirm({
            url:"/admin/siteSetting/delete/"+id,
    ...
    $(document).off('click', '#add_sitesetting').on('click', '#add_sitesetting', function(e){
        ...
        e.stopPropagation();
        showModal({
            url: '/admin/siteSetting/addmodal'	
        });
    })
