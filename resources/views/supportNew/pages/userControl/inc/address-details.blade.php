<div class="address_info_title_name">
    ...
    <span class="add_address_details" id="addressBox" data-target="#sy_global_modal" data-toggle="modal" data-route="/admin/address/addAddressDetails/" data-id="{{$user->member->id}}" user-id = "{{$user->id}}">
                            ...
                            <tbody>
                                <tr style="text-align: right;">
                                    ...
                                    <td class="d-flex justify-content-between align-items-center">
                                        <a title="Edit details" data-target="#sy_global_modal" data-toggle="modal" data-route="/admin/userProfile/address/{{$address->id}}" data-id="{{$user->member->id}}" class="btn btn-hover-brand btn-icon btn-pill model_load update_address_details"><i class="la la-edit" title="Edit"></i>								
                                        </a>

                                        {{-- delete --}}
                                        <a title="Delete" data-target="#sy_global_modal" data-toggle="modal" data-route="/admin/address/deleteAddress/{{$address->id}}" data-id="{{$address->id}}" class="btn btn-hover-danger btn-icon btn-pill m_deteteAddress">								
