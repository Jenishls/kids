                        ...
                        <tbody>
                            <tr style="text-align: right;">
                                ...
                                <td class="d-flex justify-content-between align-items-center">
                                    <a title="Edit details" data-target="#sy_global_modal" data-toggle="modal" data-route="/admin/userProfile/contact/{{$user->id}}" class="btn btn-hover-brand btn-icon btn-pill model_load update_address_details" data-id="{{$user->id}}"><i class="la la-edit"></i>								
                                    </a>
                                </td>
                            </tr>
                            {{-- Begin Contact Info  --}}
