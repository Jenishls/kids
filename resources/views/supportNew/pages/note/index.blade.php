...
<div class="kt-subheader kt-grid__item uc_subHeader userControlSubHeader" id="kt_subheader">
    ...
    <div class="kt-subheader__wrapper">
        <button class="btn btn-pill btn-brand btn-elevate btn-icon-sm" id="add_note"><i class="la la-plus"></i>
            Note
        </button>
    </div>
</div>
            ...
            columns: [
                    ...
                    },
                    {
                        ...
                        template: function(row, index, datatable) {
                            ...
                            return     '<a id="edit_note" class="btn btn-hover-brand btn-icon btn-pill model_load" data-route="/admin/note/edit/'+row.id+'" href="JavaScript:void(0);" data-toggle="modal" data-target="#sy_global_modal"  title="Edit details">\
