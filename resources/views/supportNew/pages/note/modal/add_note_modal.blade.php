                            ...
                            <div class="m-portlet__body no-pd-i" style="padding-bottom: 10px !important;">
                                <div class="form-group m-form__group row no-pd-right no-pd-left m-t-10">
                                    ...
                                    <div class="col-lg-2 col-sm-6 mb-lg-0 mb-3 pt_lbl">
                                            ...
                                            <input type="text" class="form-control form-control-sm m-input" id="note_code" name="note_code" autocomplete="off" data-advanced="" data-lookup="/admin/lookup/getData/note_code" style="width:94%;" title="Note Code">
                                    </div>
