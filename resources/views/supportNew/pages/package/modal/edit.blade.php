                                                ...
                                                <table class="kt-datatable__table" style="display: block; padding-bottom: 45px;">
                                                    ...
                                                    <tbody class="kt-datatable__body" id="selected_items_table">
                                                        ...
                                                        <tr data-row="0" data-inv-id="{{$item->inv_id}}" class="kt-datatable__row" style="left: 0px;">
                                                            ...
                                                            <td data-field="ShipDate" class="kt-datatable__cell"><span style="width: 70px;">{{$item->inventory->price?:0}}</span></td>
                                                            ...
                                                            <td data-field="Type" data-autohide-disabled="false" class="kt-datatable__cell type_td">
                                                                <span style="width: 105px;">
                                                                    <select class="form-control type" name="type[]" data-price="{{$item->inventory->price}}" style="width:100%; display:inline-block;">
                                                            ...
                                                            <td data-field="Type" data-autohide-disabled="false" class="kt-datatable__cell dis_type_td">
                                                                <span style="width: 140px;">
                                                                    <select class="form-control dis_types" data-price="{{$item->inventory->price?:0}}" name="dis_type[]" id="" style="width:55%; display:inline-block;">
                                                                ...
                                                                <input class="form-control discounts" type="text" data-price="{{$item->inventory->price?:0}}" name="discount[]" value="{{$item->dis_rate?:0}}" required="require" autocomplete="off" style="width:41%; display:inline-block;">
                                                                </span>
                                                            </td>
                                                            <td class="kt-datatable__cell--center kt-datatable__cell pr-0 dis_amt_td" data-field="disAmt">
                                                                <span class="dis_amt" style="overflow: visible; position: relative; width: 65px;">                     
                                                                        {{$item->dis_amt?:0}}
                                                                </span>
    ...
    <script>
        $(document).ready(function(e){
            ...
            function g_total(){
                ...
                $('#g_total_input').val(Number(g_total).toFixed(2));
