    ...
    <div class="m-portlet m-portlet--mobile with-border">
        <div class="m-portlet__body">
            ...
            <div class="m-form m-form--label-align-right m--margin-top-bottom">
                <div class="form-group m-form__group row justify-content-start toolbar justify-content-start">
                    <!-- Advance Filter -->
                    <!-- Advance Filter -->
                        ...
                        <div class="col-auto">
                            <div class="input-group m-input-group" style="border-radius: 20px !important;">
                                ...
                                <input type="text" name="temp_name" id="TemplateName"
                                           class="form-control applicationIDFilter"
                    ...
                    <div class="col-auto">
                        <button type="button" title="Reset Search" data-route="admin/email_template" class="btn btn-xs btn-outline-primary m-btn btn-icon btn-pill pageload">
