            ...
            <div class="blog-single-sidebar bordered blog-container">
                <div class="blog-single-sidebar-search">
                    <div class="input-group mb-3 input-group-sm userInputGroup">
                        ...
                        <input type="text" class="form-control" data-route="/blog/search/" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default" placeholder="Keywords.." id="blogSearch" autocomplete="off">
                    </div>
                </div>
                <div class="blog-single-sidebar-recent blog-single-sidebar">
                    <div class="rec_title"> 

                        <h3 class="blog-sidebar-title uppercase" style="    width: 151px;"><i class="fas fa-sync" style="font-size: 13px;padding-right: 10px; color: #f67448;"></i>Recent Posts</h3>
                    </div>
                    <ul>
                        @foreach($blogs as $blog)
                        <li class="kt-nav__item viewBlog" data-route="/view/blog/{{$blog->id}}">
                ...
                <div class="blog-single-sidebar-links blog-single-sidebar" style="margin-top:50px;">
                    <div class="cat_title">
                        <h3 class="blog-sidebar-title uppercase">
                            <i class="fas fa-bars" style="font-size: 13px;padding-right: 10px; color: #f67448;">
                            </i>
                            Categories
                        </h3>
                    </div>
                    ...
                    <ul>
                        ...
                        <li class="uppercase blogCategoryTags" data-route="/categoryBlog/{{$category->id}}">
