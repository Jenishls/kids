...
<div id="validation_container" class="validation_index">
    ...
    <div class="kt-subheader kt-grid__item uc_subHeader " id="kt_subheader">
		<div class="kt-container validation_breadcumb">
            ...
            <div>
                <button class="btn btn-info m-btn add_validation_btn" data-target="#sy_global_modal" data-toggle="modal"  id="addValidation" title="Add Validation">
                    <span>
                ...
                <div class="kt-section">
                        <div class="add_validation_section_div">
                            ...
                            <div class="kt-subheader__wrapper" title="Add Section">
                                <a class="btn btn-brand btn-elevate btn-icon-sm create_new_section" data-route="/validation/addSectionModal" id="addSection" style="color: white; height: 34px;"><i class="la la-plus validation_section_add_icon" style="padding-bottom: 6px;"></i>
                        ...
                        <ul class="kt-nav kt-nav--bold kt-nav--md-space kt-nav--v3 "  role="tablist" id="validationSectionsContainer">
                            ...
                            {{-- <div class="load_validations"> --}}
                                <li class="kt-nav__item  validation_sections_element"  role="tab">
                                    <a class="kt-nav__link load_validations" data-id="{{$section->id}}" data-toggle="tab" data-route="/validations/list/{{$section->id}}"  style="padding-top:0; padding-left:0; width: 285px;" >
                                        <span class="kt-nav__link-text">{{ucfirst($section->section)}}</span>
                                    </a>
                                    <div class="section_edit_delete">
                                        <i class="la la-edit validation_section_li_edit " data-route="/validation/editSectionModal/{{$section->id}}" data-toggle="modal" data-target="#sy_global_modal"style="font-size: 16px; padding: 0px 9px;"></i>
