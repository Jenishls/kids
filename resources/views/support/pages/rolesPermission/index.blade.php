        ...
        <div class="kt-container ">
            ...
            <div class="kt-subheader__toolbar rp_subheader_toolbar row">
                <div class="no-padding col-lg-2">
                    <div class="page-menu">
                        <div class="rp_menus">
                            <div id="role-page" class="rp_menu rp_menu_active" data-pageIndex="0" data-tab = "/" data-url = 'rolePermission/pages'>
                                <a class="rp_menu_nav_link"><i class="far fa-file-alt rp_menu_icon"></i><p class="page_tab_name" style="margin:0;">Pages</p></a></div>
                            
                            <div id="role-role" class="rp_menu" data-pageIndex="1" data-tab = "/rolePermission/roles" data-url = 'rolePermission/roles'>
                                <a class="rp_menu_nav_link"><i class="fas fa-user-lock rp_menu_icon"></i><p class="page_tab_name" style="margin:0;">Roles</p></a>
                            </div>
                            <div id="role-permission" class="rp_menu" data-pageIndex="2" data-tab = "/rolePermission/permission" data-url = 'rolePermission/permission'>
                            ...
                            <div id="role-permissionMgmt" class="rp_menu" data-pageIndex="3" data-tab = "/rolePermission/permissionManagement" data-url = 'rolePermission/permission_management'>
                            ...
                            <div id="role-permissionUser" class="rp_menu" data-pageIndex="4" data-tab = "/rolePermission/userPermissions" data-url = 'rolePermission/user_permission'>
