<style>
    ...
    <div class="modal-dialog note_create_modal_dialog" role="document" id="addNoteModal" style="diaplay:block;">
       <div class="modal-content note_create_modal_content" >
            ...
            <div class="modal-body has-divider note_create_body" style="padding-top: 25px !important;">
                <form id="noteUpdate" enctype="multipart/form-data" class="m-form m-form--label-align-right">
                    @csrf
                    <div class="row no-padding">
                        <div class="col-md-4 no-padding" style="border-right: 1px solid #e4e4e4;height:500px;">
                                ...
                                <div class="m-portlet__body no-pd-i" style="padding-bottom: 10px !important;">
                                    <div class="form-group m-form__group row no-pd-right no-pd-left m-t-10">
                                        <div class="col-lg-8 col-sm-12 mb-lg-0 mb-3">
                                            ...
                                            <input type="text" class="form-control form-control-sm m-input ucfirst ml-3" value="{{$note->title}}" name="title" id="note_title" autocomplete="off" style="width:97%;">
                                        ...
                                        <div class="col-lg-4 col-sm-12 mt-20 pt_lbl">
                                            ...
                                            <input type="text" class="form-control form-control-sm m-input ml-3" value="{{$note->start_date.'/'.$note->end_date}}" name="start_date" id="start_end_date" autocomplete="off" title="Start and End Date">
                                        </div>
                                         <div class="col-lg-2 col-sm-12 mt-20 pt_lbl">
                                            <label class="ml-3 lbl" for="reminder_date">Reminder Date</label>
                                             <input type="text" class="form-control form-control-sm m-input ml-2" value="{{$note->reminder_date}}" name="reminder_date" id="reminder_date" autocomplete="off">
                                            <div class="errorMessage"></div>
                                        ...
                                        <div class="col-lg-2 col-sm-6  mt-20 pt_lbl">
                                            ...
                                            <input type="text" class="form-control form-control-sm m-input note-datepicker" name="todo_date" value="{{$note->todo_date}}" id="note_todo" autocomplete="off" title="To Do Date">
                                            <div class="errorMessage"></div>
                                        ...
                                        {{-- <div class="col-lg-2 col-sm-6 mt-20 row">
                                            <div class="col-md-12  no-padding">
                                                ...
                                                <input type="text" class="form-control form-control-sm m-input" id="note_code" name="note_code" autocomplete="off" data-advanced="" data-lookup="/lookup/getData/note_code">
                                            </div>
                                        </div> --}}
                                        ...
                                        <div class="col-sm-12 mt-20 pt_lbl">
                                            ...
                                            <textarea name="description" id="summernote" style="display: none;">{{$note->description}}</textarea>
                                        </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <button type="button" class="btn btn-success m-btn--icon m-btn--pill float-right" id="updateNote" data-id="{{$note->id}}" data-target="NoteCreate">
                    <span>
                        <span>Save</span>
                    </span>
                </button>
    ...
    $(document).off('click', '#updateNote').on('click', '#updateNote', function(e){
       ...
       $.ajax({
            url: '/note/update/'+id,
            method: 'POST',
            data: new FormData(document.getElementById('noteUpdate')),
            contentType: false,
            processData: false,
            ...
            {
                if(status===422){
                    noteUpdate.find('input[name], select[name]').css('border-color', '#ddd');
                    ...
                    for (const [key, message] of Object.entries(responseJSON.errors)) {
                        noteUpdate.find(`input[name = "${ key }"]`).css('border-color', '#F44336');
                        noteUpdate.find(`select[name = "${ key }"]`).siblings('button').css('border-color', '#F44336');
