<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="/metronic/preview/demo1/custom/apps/projects/add-project.html" class="btn btn-label-brand btn-bold">
    ...
    <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        @include('support.pages.dashboard.projects.inc.projects')
        <!--End::Section-->
                            ...
                            <div class="kt-widget__head">
                                <div class="kt-widget__label">
                                    ...
                                    <div class="kt-widget__info kt-margin-t-5">
                                        <a href="#" class="kt-widget__title projectWidgetTitle">
                                            Nexa - Next generation SAAS
                                        </a>
                                        <span class="kt-widget__desc projectWidgetDesc">
                                ...
                                <div class="kt-widget__wrapper">
                                    <div class="kt-widget__section">
                                        <div class="kt-widget__blog">
                                            ...
                                            <a href="#" class="kt-widget__value kt-font-brand projectFontBrand">72 Tasks</a>
                                        </div>

                                        <div class="kt-widget__blog">
                                            <i class="flaticon2-talk"></i>
                                            <a href="#" class="kt-widget__value kt-font-brand projectFontBrand">648 Comments</a>
                                        </div>
                                    </div>
