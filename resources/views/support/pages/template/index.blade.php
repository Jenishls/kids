...
<div class="template_container">
    ...
    <div class="kt-subheader kt-grid__item uc_subHeader " id="kt_subheader">
        <div class="kt-container validation_breadcumb">
            ...
            <div>
                <button class="btn btn-brand m-btn " data-target="#sy_global_modal" data-toggle="modal" id="addTemplate" title="Add Template ">
                    <span>
    ...
    <div class="row ui-sortable"  style="padding-top:25px; width: 100%;" >
        ...
        {{-- {{dd($template)}} --}}
        <div class="col-lg-3 template_div" id="kt_sortable_portlets" draggable="true">	
    
            <!--begin::Portlet-->
            <div class="kt-portlet kt-portlet--mobile kt-portlet--sortable" style="padding-bottom: 18px;">
                <div class="kt-portlet__head ui-sortable-handle" style="padding-left: 12px; padding-right: 7px;">
                ...
                <div class="kt-portlet__body" style="padding:0; height: 284px;">
                    ...
                    <a class="btn btn-brand btn-elevate view_template" data-route="/cms/{{$template->id}}" >View</a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    return {
        ...
        init: function () {
            $("#kt_sortable_portlets").draggable({
