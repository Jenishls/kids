	...
	// datasource definition
			...
			},
		{
			...
			template: function(row, index, datatable) {
				...
				return     '<a class="btn btn-hover-brand btn-icon btn-pill model_load edit_cms_page" data-route="/cms/editmodal/page/'+row.id+'" href="JavaScript:void(0);" data-toggle="modal" data-target="#sy_global_modal"  title="Edit details">\
	...
	$(document).off('click', '#add_cms_page').on('click', '#add_cms_page', function(e){
		...
		showModal({
			url: '/cms/addmodal/page/'+template_id	
		});
