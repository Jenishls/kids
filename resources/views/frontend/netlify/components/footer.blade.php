...
<footer id="footer" class="footer">
    ...
    <div class="footer-widgets-area pt-100 pb-60">
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-full-width">
                    <div class="footer__description text-center">
                        <a href="index-2.html"><img src="{{asset('netlify/images/logo/footer-logo.png')}}" alt="footer logo"></a>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="single_contact_info">
                        ...
                        <div class="info">
                            <p>7777 modern Avenue, Suite 05, New York,
                                CA 9077, USA 2018
                            </p>
                        </div>
                ...
                <div class="col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="single_contact_info">
                        ...
                        <div class="info">
                            ...
                            <p><a href="#">www.yourwebsite.com</a></p>
                        </div>
                    </div><!-- End single contact info -->
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-sm-7 col-xs-12">
                    <div class="copyright">
                        <p>&copy; 2018 Copyright <a href="#">Createuiux</a> All rights reserved.</p>
                    </div><!-- Copyright Text -->
                </div>
