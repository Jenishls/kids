<div class="menu-left">
    ...
    <div class="brand-logo crates_logo load_pages" onclick="location.reload();">
        <a ><img src="{{asset('cratesOnSkatesImages/cratesOnSkatesLogo.png')}}" class="img-fluid blur-up lazyload" alt=""></a>
    </div>
</div>