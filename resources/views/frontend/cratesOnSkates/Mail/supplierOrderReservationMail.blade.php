...
<head>
  ...
  <title>Suppliers Order Reservation Mail</title>
      ...
      <tr>
        <td>
          <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
              <td colspan="2">
                <p style="font-size: 14px;text-align:left;margin:0px;">New order has been created. Kindly find following order summary.</p>
              </td>
            </tr>
          </table>
          <!-- Dates Start -->
          ...
          <div class="d-table" style="margin-bottom: 15px;margin-left: auto"">
            {{-- <div class="tr">
              <div><b >Payment By:</b></div>
              <div>{{ucfirst($order->payment->card_last_name)}}</div>
            </div> --}}
            <div class="tr">
