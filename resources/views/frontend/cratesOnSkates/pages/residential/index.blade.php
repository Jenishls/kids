...
<div class="sec-resi radial-th-gradient">
    <div class="container cs-container-wrapper">
        <div class="row">
            ...
            <div class="col-lg-10 offset-lg-1 col-md-12 col-sm-12 no-pd-left" style="padding-bottom: 100px; padding-top: 30px">
...
<script type="text/javascript">
    ...
    function backToFeatures() {
        ...
        $("#backPrice"+packageId).text("$"+price).removeClass("buttonBack");
