...

                        {
                            ...
                            template: function(row, index, datatable) {
                                ...
                                return (
                                    ...
                                    row.id +
                                    '" data-route="/admin/lookup/addGroup/' +
                                    row.code +
...
$(document)
    ...
    .on("click", "#addLookupSection", function(e) {
        ...
        e.stopPropagation();
        showModal({
            url: "/admin/lookup/addSectionModal"
        });
    });
...
$(document)
    ...
    .on("click", ".add_new_lookup_fields", function(e) {
        ...
        showModal({
            url: "/admin/lookup/addLookupModal/" + section_id
        });
    });
...
$(document)
    ...
    .on("click", ".edit_lookup", function(e) {
        ...
        showModal({
            url: "/admin/lookup/editLookupModal/" + lookup_id
        });
    });
...
$(document)
    ...
    .on("click", ".delLookupGroupButton", function(e) {
        ...
        delConfirm({
            url: "/admin/lookup/deleteLookupGroup/" + lookup_id,
            header: $(`#${table}`)
        });
    });
...
function setActiveRowCallback(callback = null, url) {
...
// datatable active row functions
function quoteTableActive() {
    let url = Cookies.get("quoteTableActive");
    $(`[data-route="${url}"]`)
        .closest("tr")
        .addClass("active_row")
...
function billTableActive() {
    let url = Cookies.get("billTableActive");
    $(`[data-route="${url}"]`)
        .closest("tr")
        .addClass("active_row")
        .siblings("tr.active_row")
...
function purchaseOrderTableActive() {
    let url = Cookies.get("purchaseOrderTableActive");
    $(`[data-route="${url}"]`)
        .closest("tr")
        .addClass("active_row")
        .siblings("tr.active_row")
