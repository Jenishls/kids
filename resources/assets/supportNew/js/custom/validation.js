        ...
        `;
                ...
                $(`#${table}`).KTDatatable({
                    ...
                    data: {
                        ...
                        source: {
                            read: {
                                url: `/admin/validations/tableList/${id}`,
                                method: "GET",
                                params: {
                                    _token: "{{ csrf_token() }}"
                                }
                            ...
                            template: function(row, index, datatable) {
                                var dropup =
                                    datatable.getPageSize() - index <= 4
                                        ...
                                        : "";
                                return (
                                    '<a id="edit_validationSection" class="btn btn-hover-brand btn-icon btn-pill model_load" data-route="/admin/validation/editmodal/' +
                                    row.id +
