...
$(document)
    ...
    .on("click", ".profile_update", function(e) {
        ...
        let url =
            "/dashboard/update/userImageTitle" + "/" + $(this).attr("data-id");
...
$(document)
    ...
    .on("click", "#change_user_password", function(e) {
        ...
        supportAjax(
            {
                url: "/dashboard/user/updatePassword/" + userId,
                method: "POST",
                data: data
            },
            function(resp) {
...
$(document)
    ...
    .on("click", ".profile_image_update", function(e) {
        ...
        let url =
            "/dashboard/update/profileImage/userImage" +
            "/" +
            $(this).attr("data-id");
...
function userPreview() {
    supportAjax(
        {
            url: "/dashboard/user/userPreview"
        },
        function(resp) {
            $("#userPreview")
                .empty()
