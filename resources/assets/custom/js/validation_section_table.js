...
$(document)
    ...
    .on("click", "#addValidation", function(e) {
        ...
        if (section_id == null) {
            ...
            showModal({
                url: "/validation/addValidationModal/" + section_id
            });
        }
    });
...
$(document)
    ...
    .on("click", "#update_validation", function(e) {
        ...
        supportAjax(
            {
                url: "/validation/update/" + $(this).data("id"),
                method: "post",
                data: data
            },
            function(resp) {
...
$(document)
    ...
    .on("click", "#update_validation_section", function(e) {
        ...
        supportAjax(
            {
                url: "/validation/updateSection/" + $(this).data("id"),
                method: "post",
                data: data
            },
            function(resp) {
...
$(document)
    ...
    .on("click", ".delValidationSectionButton", function(e) {
        ...
        let id = $(this).data("id");
        delConfirm({
            url: "/validation/deleteSection/" + id,
            appendView: $("#kt_body")
        });
    });
