...
//
    ...
    private function phantomProcess($path, $mode, $time)
    {
        ...
        elseif ($mode == 'header_footer'):
            $command = app_path() . DIRECTORY_SEPARATOR . 'Lib' . DIRECTORY_SEPARATOR . 'Capture' . DIRECTORY_SEPARATOR . 'bin' . DIRECTORY_SEPARATOR . 'phantomjs ' . app_path() . DIRECTORY_SEPARATOR . 'Lib' . DIRECTORY_SEPARATOR . 'Capture' . DIRECTORY_SEPARATOR . 'header_footer_capture.js ' . $path;
