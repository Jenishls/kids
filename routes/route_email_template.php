...
Route::prefix('admin')->group(function() {
    ...
    Route::get('email_template/getTempCode', 'EmailTemplateController@getTempCode');
    Route::get('getTempJson/{val}', 'EmailTemplateController@getTempJson');
    // add template
    ...
    //
    Route::get('defaultTemplate/singleTemplate/{template}', 'DefaultTemplateController@view');
